//
//  CurrentTimelineFollowingTableViewController.swift
//  Timeline
//
...
class CurrentTimelineFollowingTableViewController: FlatTimelineTableViewController {
    ...
    override func refreshTableView() {
        ...
        Timeline.getTimelines(ApiRequest.CurrentTimelineFollowing) { tls in
            self.timelines = tls
            if !first {
