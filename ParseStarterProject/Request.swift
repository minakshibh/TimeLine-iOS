...
//    private static let baseUrl = NSURL(string: "http://54.187.225.1")!    // for client54.191.59.21
    private static let baseUrl = NSURL(string: "http://54.191.59.21")!      // Latest Client Server
